...
data class LineJoin (val code: String, val raw: String)

class SvgStrokeLineJoin(val text: String)
{
    val lineJoins = arrayListOf(
            LineJoin("ARCS", "arcs"),
    ...
    fun ofRaw(raw: String) = lineJoins.firstOrNull { it.code == raw }
